...
namespace EnterTheIUT.Metier.Armes
{
    ...
    public class ProjectileEnnemi : GameItem, IAnimable
    {

        private double angle;
        public ProjectileEnnemi(double angle, double x, double y, Game game, string spriteName = "projectiles/ennemi_projectile.png", int zindex = 0) : base(x, y, game, spriteName, zindex)
        {
            this.angle = angle;

        }

        public override string TypeName => "projectile_ennemi";
